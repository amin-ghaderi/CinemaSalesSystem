...
{
    public static Guid PromptShowTimeSelection(IEnumerable<ShowTimeViewModel> showTimes)
    {
    ...
    public static int PromptTicketQuantity()
    {
        return InputHelper.ReadInt("\nEnter ticket quantity: ", 1, int.MaxValue);
    }

    public static void DisplayPurchaseResult(TicketViewModel ticket)
    {
